...
//    }
    ...
    var pokemonViewModel: PokemonViewModel? {
        didSet {
            nameLabel.text = pokemonViewModel?.name
            imageView.image = pokemonViewModel?.image
            originalPokemonLabel.text = pokemonViewModel?.originalPokemonText
            baseExperienceLabel.text = pokemonViewModel?.baseExperienceText
            self.tableView.reloadData()
        }
    }
