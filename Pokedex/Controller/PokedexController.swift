...
extension PokedexController {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.delegate = self
        var pokemonViewModelToSend: PokemonViewModel!
        pokemonViewModelToSend = inSearchMode ? filteredPokemonViewModels[indexPath.item] : pokemonViewModels[indexPath.item]
        cell.pokemonViewModel = pokemonViewModelToSend
...
extension PokedexController: PokedexCellDelegate {
    ...
    func presentInfoView(withPokemonViewModel pokemonViewModel: PokemonViewModel) {
        ...
        Service.shared.fetchPokemonData(forPokemon: pokemon) {
            ...
            self.infoView.pokemonViewModel = PokemonViewModel(pokemon: pokemon)
